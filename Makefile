...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Common.v LambdaCDollar.v LambdaDollarToLet.v LambdaDollar.v LambdaFDollar.v LambdaLetDollar.v STLC_Generic.v stlc.v Terms.v -o Makefile
